<?php global $s_v_data, $title, $user, $receipt, $owner; ?>
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>You are viewing receipt #<?=  $receipt->id ; ?>.</p>
                                            </div>
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="<?=  url('Projectpayment@render', array('receiptid' => $receipt->id)) ; ?>" download="Receipt #<?=  $receipt->id ; ?>.pdf"><em class="icon ni ni-download-cloud"></em><span>Download</span></a></li>
                                                                <li><a href="<?=  url('Projectpayment@render', array('receiptid' => $receipt->id)) ; ?>" target="_blank"><em class="icon ni ni-printer"></em><span>Print</span></a></li>
                                                                <li><a class="fetch-display-click" data="receiptid:<?=  $receipt->id ; ?>" url="<?=  url('Projectpayment@updateview') ; ?>" holder=".update-holder-xl" modal="#update-xl" href=""><em class="icon ni ni-pen"></em><span>Edit Receipt</span></a></li>
                                                                <li class="divider"></li>
                                                                <li><a class="send-to-server-click"  data="receiptid:<?=  $receipt->id ; ?>" url="<?=  url('Projectpayment@delete') ; ?>" warning-title="Are you sure?" warning-message="This receipt will be deleted permanently." warning-button="Yes, delete!" href=""><em class="icon ni ni-trash"></em><span>Delete Receipt</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
    ...
    <script type="text/javascript">
        ...
        var pdfDocument = "<?=  url('Projectpayment@render', array('receiptid' => $receipt->id)) ; ?>";
