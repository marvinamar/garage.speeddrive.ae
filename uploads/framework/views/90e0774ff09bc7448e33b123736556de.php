<?php global $s_v_data, $items, $user, $suppliers, $jobcard, $inventory; ?>
                ...
                <form class="simcy-form" action="<?=  url('Expenses@addbulk') ; ?>" data-parsley-validate="" method="POST" loader="true">
                    <div class="modal-body">
                                ...
                                <div class="row gy-4 pt-2 external-source">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" placeholder="Expense / Item name" name="expense<?=  $index ; ?>" required="" value="<?=  $item ; ?>">
                                ...
                                <div class="row gy-4 pt-2 inventory-source" style="display: none;">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select class="form-control select2-dynamic inventory-select" name="inventory">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="number" class="form-control form-control-lg" placeholder="Units Consumed" data-parsley-pattern="^[0-9]\d*(\.\d+)?$" name="consumed" value="0.00" step="0.01">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="number" class="form-control form-control-lg" placeholder="Amount" data-parsley-pattern="^[0-9]\d*(\.\d+)?$" name="totalamount" value="0.00" step="0.01" required="" readonly="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <div class="row gy-4">
                            <div class="col-sm-12">
                                <div class="alert alert-fill alert-warning alert-icon"><em class="icon ni ni-alert-circle"></em> No items added on this jobcard.</div>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
