                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li><a href="" class="btn btn-primary fetch-display-click"
                                                                data="secure:true" url="<?=  url('Projects@booking') ; ?>"
                                                                holder=".update-project-holder"
                                                                modal="#update-project"><em
                                    ...
                                    <div class="card card-stretch">
                                        <div class="card-inner table-responsive">
                                                ...
                                                <div class="col-sm-12"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" name="filter_by_date"
                                                                id="filter_by_date"
                                                                class="custom-control-input expense-paid" value="Yes">
                                                            <label class="custom-control-label"
                                                                for="filter_by_date">Include Date</label>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="col-md-3">
                                                    <span>From: <input type="date" name="from_date" id="from_date"
                                                            class="form-control" value="<?=  date('Y-m-d') ; ?>"></span>
                                                </div>
                                                <div class="col-md-3">
                                                    <span>To: <input type="date" name="to_date" id="to_date"
                                                            class="form-control" value="<?=  date('Y-m-d') ; ?>"> </span>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <table class="nk-tb-list nk-tb-ulist" data-auto-responsive="false"
                                                id="datatable_init_projects" style="width: 100%;">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        <th class="nk-tb-col text-center">#</th>
                                                        <th class="nk-tb-col"><span class="sub-text">Date</span></th>
                                                        <th class="nk-tb-col"><span class="sub-text">Client Name</span>
                                                        </th>
                                                        <th class="nk-tb-col"><span class="sub-text">Vehicle
                                                                Number/Status</span></th>
                                                        <?php if ($user->role == "Owner" || $user->role == "Manager") { ?>
                                                        <th class="nk-tb-col"><span class="sub-text">Total
                                                                Invoice</span></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        ...
                                                        <?php if ($user->role == "Owner" || $user->role == "Manager") { ?>
                                                        <td class="nk-tb-col">
                                                            <span><?=  date("M d, y", strtotime($project->start_date)) ; ?>
                                                                <br> <?=  date("M d, y", strtotime($project->end_date))
                                                                ; ?></span>
                                                        </td>
                                                        <?php } ?>
                                                        <td class="nk-tb-col">
                                                            <div class="user-card">
                                                                <div
                                                                    ...
                                                                    <span><?=  mb_substr($project->client->fullname, 0, 2,
                                                                        "UTF-8") ; ?></span>
                                                                </div>
                                                                <div class="user-info">
                                                                    <span class="tb-lead"><?=  $project->client->fullname
                                                                        ; ?> <span
                                                        ...
                                                        <td class="nk-tb-col">
                                                            <span class="tb-amount"><?=  carmake($project->make) ; ?> <?= 
                                                                carmodel($project->model) ; ?>
                                                                <?php if (!empty($project->insurance)) { ?>
                                                                <span class="text-success" data-toggle="tooltip"
                                                                    title="Covered by Insurance"><em
                                                                        class="icon ni ni-shield-check-fill"></em></span>
                                                                <?php } ?>
                                                            </span>
                                                            ...
                                                            <span
                                                                class="badge badge-sm badge-dot has-bg badge-success d-mb-inline-flex">Completed</span>
                                                            <?php } else if ($project->status == "Cancelled") { ?>
                                                            <span
                                                                class="badge badge-sm badge-dot has-bg badge-secondary d-mb-inline-flex">Cancelled</span>
                                                            <?php } else if ($project->status == "Booked In") { ?>
                                                            <span
                                                                class="badge badge-sm badge-dot has-bg badge-danger d-mb-inline-flex">Booked
                                                                In</span>
                                                            <?php } else { ?>
                                                            <?php if (date('Y-m-d', strtotime($project->end_date)) < date('Y-m-d')) { ?> 
                                                            <span class="badge badge-sm badge-dot has-bg badge-danger d-mb-inline-flex">
                                                                Over due</span>
                                                                <?php } else { ?>
                                                                <span
                                                                    class="badge badge-sm badge-dot has-bg badge-warning d-mb-inline-flex">In
                                                                    Progress</span>
                                                                <?php } ?>
                                                                <?php } ?>
                                                        </td>
                                                        <?php if ($user->role == "Owner" || $user->role == "Manager") { ?>
                                                        <td class="nk-tb-col">
                                                            <span><?=  money($project->invoiced, $user->parent->currency)
                                                                ; ?></span><br>
                                                        </td>
                                                        <td class="nk-tb-col">
                                                            <span><?=  money(($project->receipt), $user->parent->currency)
                                                                ; ?></span>
                                                        </td>
                                                        <td class="nk-tb-col">
                                                            <span class="tb-amount"><?=  money(($project->invoiced -
                                                                $project->receipt), $user->parent->currency) ; ?></span>
                                                        </td>
                                                        <?php } ?>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a
                                                                                        href="<?=  url('Projects@details', array('projectid' => $project->id,'Isqt' => 'false')) ; ?>"><em
                                                                                            class="icon ni ni-eye"></em><span>View
                                                                                            Details</span></a></li>
                                                                                <?php if ($user->role == "Owner" || $user->role == "Manager") { ?>
                                                                                <li><a class="fetch-display-click"
                                                                                        data="projectid:<?=  $project->id ; ?>"
                                                                                        url="<?=  url('Projects@updateview') ; ?>"
                                                                                        holder=".update-project-holder"
                                                                                        modal="#update-project"
                                                                                        href=""><em
                                                                                            class="icon ni ni-pen"></em><span>Edit
                                                                                            Details</span></a></li>
                                                                                <li><a href="" class="create-jobcard"
                                                                                        data-id="<?=  $project->id ; ?>"><em
                                                                                            class="icon ni ni-property-add"></em><span>Create
                                                                                            Job Card</span></a></li>
                                                                                <li class="divider"></li>
                                                                                <li><a href="" class="create-quote"
                                                                                        data-type="project"
                                                                                        data-id="<?=  $project->id ; ?>"><em
                                                                                            class="icon ni ni-cards"></em><span>Create
                                                                                            Quote</span></a></li>
                                                                                <li><a href="" class="create-invoice"
                                                                                        data-type="project"
                                                                                        data-id="<?=  $project->id ; ?>"><em
                                                                                            class="icon ni ni-cc"></em><span>Create
                                                                                            Invoice</span></a></li>
                                                                                <?php if ($project->status == "In Progress") { ?>
                                                                                <li><a href=""
                                                                                        class="send-to-server-click"
                                                                                        data="projectid:<?=  $project->id ; ?>"
                                                                                        url="<?=  url('Projects@cancel') ; ?>"
                                                                                        warning-title="Are you sure?"
                                                                                        warning-message="This project will be marked as cancelled."
                                                                                        warning-button="Yes, Cancel!"><em
                                                                                            class="icon ni ni-na"></em><span>Cancel
                                                                                            Project</span></a></li>
                                                                                <?php } ?>
                                                                                <?php } ?>
                                                                                ...
                                                                                <li><a class="send-to-server-click"
                                                                                        ...
                                                                                        warning-title="Are you sure?"
                                                                                        warning-message="This project will be deleted permanently."
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td class="text-right nk-tb-col tb-col-md" colspan="4"><span
                                                                class="fw-bold">Total:</span></td>
                                                        <td class="nk-tb-col tb-col-md"> <span class="tb-amount"><?= 
                                                                money(0, $user->parent->currency) ; ?></span> </td>
                                                        <td class="nk-tb-col tb-col-md"> <span class="tb-amount"><?= 
                                                                money(0, $user->parent->currency) ; ?></span> </td>
                                                        <td class="nk-tb-col tb-col-md"> <span class="tb-amount"><?= 
                                                                money(0, $user->parent->currency) ; ?></span> </td>
    ...
    <div class="modal fade" tabindex="-1" id="createquote">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form class="simcy-form" action="<?=  url('Quote@create') ; ?>" data-parsley-validate="" method="POST"
                    loader="true">
                    <div class="modal-body">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="item[]" id="item[]" class="select_1 form-control"
                                                data-live-search="true" onchange="get_item_details(this)">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap hide-arrows">
                                            <input type="number" class="form-control form-control-lg line-quantity"
                                                value="1" min="1" placeholder="Quantity" name="quantity[]" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label class="form-label">Unit Cost ( <?=  currency($user->parent->currency) ; ?>
                                            )</label>
                                        <div class="form-control-wrap hide-arrows">
                                            <input type="number" class="form-control form-control-lg line-cost"
                                                placeholder="Unit Cost" data-parsley-pattern="[0-9]*(\.?[0-9]{2}$)"
                                                name="cost[]" value="0.00" step="0.01" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap hide-arrows">
                                            <input type="number" class="form-control form-control-lg line-tax"
                                                placeholder="Tax (%)" min="0" name="tax[]">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label class="form-label">Total ( <?=  currency($user->parent->currency) ; ?>
                                            )</label>
                                        <div class="form-control-wrap">
                                            <input type="number" class="form-control form-control-lg line-total"
                                                placeholder="Amount" data-parsley-pattern="[0-9]*(\.?[0-9]{2}$)"
                                                name="total[]" value="0.00" step="0.01" required="" readonly="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="number" class="form-control form-control-lg line-total"
                                                placeholder="Total" data-parsley-pattern="[0-9]*(\.?[0-9]{2}$)"
                                                name="total[]" value="0.00" step="0.01" required="" readonly="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <a href="#"
                                                class="btn btn-icon btn-lg btn-round btn-dim btn-outline-danger mt-gs remove-line"
                                                data-toggle="tooltip" title="Remove Item"><em
                        ...
                        <div class="item-totals border-top mt-2 pt-2">
                            <div class="row gy-4 d-flex justify-content-end">
                                <div class="col-sm-4">
                                    <a href="" class="btn btn-dim btn-outline-primary mt-2 add-item-quote"
                                        data-type="invoice"><em class="icon ni ni-plus"></em><span>Add Item</span> </a>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label class="form-label">VAT Tax (%)</label>
                                        <div class="form-control-wrap hide-arrows">
                                            <input type="number" class="form-control form-control-lg total-vat"
                                                placeholder="Tax (%)" value="<?=  $user->parent->vat ; ?>"
                                                data-parsley-pattern="^[0-9]\d*(\.\d+)?$" step="0.01" min="0"
                                                name="vat">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 text-right">
                                    <div class="fw-normal">Sub Total:<div class="fw-bold sub-total"><?= 
                                            currency($user->parent->currency) ; ?> 0.00</div>
                                    </div>
                                    <div class="fw-normal">VAT Tax:<div class="fw-bold tax-total"><?= 
                                            currency($user->parent->currency) ; ?> 0.00</div>
                                    </div>
                                    <div class="fw-bold fs-19px border-top">Total:<div class="fw-bold grand-total"><?= 
                                            currency($user->parent->currency) ; ?> 0.00</div>
                                    </div>
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="row gy-4">
                                <div class="col-12">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea class="form-control form-control-lg unset-mh" placeholder="Notes"
                    ...
                    <div class="modal-footer bg-light">
                        ...
                        <button class="btn btn-primary" type="submit"><em
                                class="icon ni ni-check-circle-cut"></em><span>Create Quote</span></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" id="createjobcard">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="simcy-form" action="<?=  url('Jobcards@create') ; ?>" data-parsley-validate="" method="POST"
                    loader="true">
                    <div class="modal-body">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="asilify-stack">
                                        <div class="stacked-inputs">
                                            <div class="form-control-wrap stacked">
                                                <input type="text" class="form-control form-control-lg"
                                                    placeholder="Body Report" name="body_report[]">
                                            </div>
                                            <div class="form-control-wrap stacked">
                                                <a href=""
                                                    class="btn btn-round btn-sm btn-icon btn-dim btn-danger remove-stack"><em
                                        ...
                                        <div class="">
                                            <a href="" class="btn btn-dim btn-primary add-stack"
                                                data-name="body_report[]" data-placeholder="Body Report"><em
                                                    class="icon ni ni-plus"></em><span>Add Item</span> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="asilify-stack">
                                        <div class="stacked-inputs">
                                            <div class="form-control-wrap stacked">
                                                <input type="text" class="form-control form-control-lg"
                                                    placeholder="Mechanical Report" name="mechanical_report[]">
                                            </div>
                                            <div class="form-control-wrap stacked">
                                                <a href=""
                                                    class="btn btn-round btn-sm btn-icon btn-dim btn-danger remove-stack"><em
                                        ...
                                        <div class="">
                                            <a href="" class="btn btn-dim btn-primary add-stack"
                                                data-name="mechanical_report[]" data-placeholder="Mechanical Report"><em
                                                    class="icon ni ni-plus"></em><span>Add Item</span> </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="asilify-stack">
                                        <div class="stacked-inputs">
                                            <div class="form-control-wrap stacked">
                                                <input type="text" class="form-control form-control-lg"
                                                    placeholder="Electrical Report" name="electrical_report[]">
                                            </div>
                                            <div class="form-control-wrap stacked">
                                                <a href=""
                                                    class="btn btn-round btn-sm btn-icon btn-dim btn-danger remove-stack"><em
                                        ...
                                        <div class="">
                                            <a href="" class="btn btn-dim btn-primary add-stack"
                                                data-name="electrical_report[]" data-placeholder="Electrical Report"><em
                                                    class="icon ni ni-plus"></em><span>Add Item</span> </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer bg-light">
                        <button class="btn btn-white btn-dim btn-outline-light" type="button" data-dismiss="modal"><em
                                class="icon ni ni-cross-circle"></em><span>Cancel</span></button>
                        <button class="btn btn-primary" type="submit"><em
                                class="icon ni ni-check-circle-cut"></em><span>Create Job Card</span></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" id="createinvoice">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form class="simcy-form" action="<?=  url('Invoice@create') ; ?>" data-parsley-validate="" method="POST"
                    loader="true">
                    <div class="modal-body">
                            ...
                            <div class="row gy-4">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="Item Description" name="item[]" required="">
                                            <input type="hidden" name="project" required="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="item-totals border-top mt-2 pt-2">
                            <div class="row gy-4 d-flex justify-content-end">
                                <div class="col-sm-4">
                                    <a href="" class="btn btn-dim btn-outline-primary mt-2 add-item"
                                        data-type="invoice"><em class="icon ni ni-plus"></em><span>Add Item</span> </a>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                            ...
                            <div class="row gy-4 border-top mt-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="date" class="form-control form-control-lg"
                                                placeholder="Invoice Date" value="<?=  date('Y-m-d') ; ?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="date" class="form-control form-control-lg"
                                                placeholder="Payment Due" name="due_date" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea class="form-control form-control-lg unset-mh"
                                                placeholder="Payment Details" rows="2"
                                                name="payment_details"><?=  $user->parent->payment_details ; ?></textarea>
                                        </div>
                    ...
                    <div class="modal-footer bg-light">
                        <button class="btn btn-white btn-dim btn-outline-light" type="button" data-dismiss="modal"><em
                                class="icon ni ni-cross-circle"></em><span>Cancel</span></button>
                        <button class="btn btn-primary" type="submit"><em
                                class="icon ni ni-check-circle-cut"></em><span>Create Invoice</span></button>
                    </div>
                </form>
            </div>
        </div>
                ...
                function (settings, data, dataIndex) {
                    ...
                    if ($('#filter_by_date').is(':checked')) {
                        ...
                        if (full_date >= from_date && full_date <= to_date) {
                            ...
                            if (status == 'completed' && data_status == 'Completed') {
                                return true
                            }
                            if (status == 'cancelled' && data_status == 'Cancelled') {
                                return true
                            }
                            if (status == 'overdue' && data_status == 'Over due') {
                                return true
                            }
                            if (status == 'inprogress' && data_status == 'In Progress') {
                                return true
                            }
                        }
                    } else {
