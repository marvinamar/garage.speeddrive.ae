                                                        ...
                                                        <div class="bq-note">
                                                            ...
                                                            <div class="bq-note-item">
                                                                ...
                                                                <div class="bq-note-meta">
                                                                    ...
                                                                    <!-- <span class="bq-note-sep sep">•</span>
                                                                    <a href="" class="link link-sm link-primary fetch-display-click" data="jobcardid:<?=  $jobcard->id ; ?>|action:insert" url="<?=  url('Jobcards@job_card_insert_in_invoice') ; ?>" >Add In Invoice</a> holder=".update-holder-lg" modal="#update-lg" -->
                                                                    <span class="bq-note-sep sep">•</span>
                                                                        ...
                                                                        <li>
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                                    ...
                                                                                    <li><a class="send-to-server-click" data="taskid:<?=  $task->id ; ?>" url="<?=  url('Tasks@add_to_invoice') ; ?>" href=""><em class="icon ni ni-plus"></em><span>Add To Invoice</span></a></li>
