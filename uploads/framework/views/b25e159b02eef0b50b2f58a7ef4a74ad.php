<?php global $s_v_data, $user, $title, $payments, $clients, $pay_expenses; ?>
                                            ...
                                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <th class="nk-tb-col tb-col-md"><span class="sub-text">Item / Remark</span></th>
                                                ...
                                                <tr class="nk-tb-item">
                                                    ...
                                                    <td class="nk-tb-col">
                                                        <div class="user-card">
                                                            <div class="user-avatar bg-dim-primary d-none d-sm-flex">
                                                                <span><?=  mb_substr($payment->supplier->name, 0, 2, "UTF-8") ; ?></span>
                                                            </div>
                                                            <div class="user-info">
                                                                <span class="tb-lead"><?=  $payment->supplier->name ; ?></span>
                                                                <span><?=  $payment->supplier->phonenumber ; ?></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="user-card">
                                                            <div class="user-info">
                                                                <span class="tb-lead"><?=  carmake($payment->expense->expense) ; ?></span>
                                                                <span><?=  $payment->expense->status ; ?></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-md">
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="<?=  url('Supplierpayment@view', array('paymentid' => $payment->id)) ; ?>"><em class="icon ni ni-eye"></em><span>View Payment</span></a></li>
