<?php global $s_v_data, $project, $insurance, $clients, $user, $partslist, $makes; ?>
<div class="modal-body">
    <p>Create a new project</p>
    <form class="simcy-form nk-wizard nk-wizard-simple is-alter" action="<?=  url('Projects@create') ; ?>" models-url="<?=  url('Projects@models') ; ?>" data-parsley-validate="" method="POST" loader="true">
        <div class="nk-wizard-head">
            <h5>Client & Vehicle Details</h5>
        </div>
        <div class="nk-wizard-content">
            ...
            <div class="row gy-4 new-client-inputs" style="display: none;">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg phone-input client" placeholder="Phone Number">
            ...
            <div class="row gy-4 deliveredby-inputs" style="display: none;">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label class="form-label">Full Name</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" placeholder="Full Name" name="deliveredby_fullname">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label class="form-label">Phone Number</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg phone-input deliveredby" placeholder="Phone Number">
                            <input class="hidden-phone" type="hidden" name="deliveredby_phonenumber">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label class="form-label">Email Address</label>
                        <div class="form-control-wrap">
                            <input type="email" class="form-control form-control-lg" placeholder="Email Address" name="deliveredby_email">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" placeholder="ID Number" name="deliveredby_idnumber">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row gy-4">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label class="form-label">Milleage In</label>
                        <div class="form-control-wrap">
                            <input type="number" class="form-control form-control-lg" placeholder="Milleage In" name="milleage">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" placeholder="Color" name="color">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="date" class="form-control form-control-lg" placeholder="Insurance Expiry" name="insurance_expiry" value="<?=  date('Y-m-d') ; ?>" required="">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" placeholder="Insurance Company" name="insurance_company" required="">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="date" class="form-control form-control-lg" placeholder="Date IN" name="date_in" value="<?=  date('Y-m-d') ; ?>" required="">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="time" class="form-control form-control-lg" placeholder="Time IN" name="time_in" value="<?=  date('H:i') ; ?>" required="">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="date" class="form-control form-control-lg" placeholder="Expected Completion Date" name="end_date" value="<?=  date('Y-m-d', strtotime(date('Y-m-d').' + 1weeks')) ; ?>" required="">
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                        ...
                        <div class="form-control-wrap ">
                            <div class="form-control-select">
                                <select class="form-control form-control-lg" name="road_test_in">
                                    ...
                                    <option value="With Client and Mechanic">With Client and Mechanic</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" placeholder="Towing Details / Notes" name="towing_details">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                         <div class="custom-control custom-switch">
                            ...
                            <label class="custom-control-label" for="covered">Repair cost covered by insurance</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="nk-wizard-content">
            <div class="row gy-4">
                ...
                <div class="col-sm-4 part-item-holder">
                    <div class="form-group">
                         <div class="custom-control custom-switch">
                            <input type="checkbox" name="partslist[]" id="part-<?=  $part->id ; ?>" has-input="<?=  $part->has_input ; ?>" class="custom-control-input" value="<?=  $part->id ; ?>">
                            <label class="custom-control-label" for="part-<?=  $part->id ; ?>"><?=  $part->name ; ?></label>
                        </div>
                        <?php if ($part->has_input == "Yes") { ?>
                        <input type="text" class="form-control form-control-sm mt-1 part-input-field" placeholder="<?=  $part->input_name ; ?>" name="partfield<?=  $part->id ; ?>" style="display: none;">
                        <?php } ?>
                    </div>
                </div>
                <?php } ?>
            ...
            <div class="row gy-2">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <textarea class="form-control" name="booking_in_notes" placeholder="Booking In Notes" rows="3"></textarea>
                        </div>
        ...
        <?php if ($user->parent->car_diagram == "Enabled") { ?>
        <div class="nk-wizard-head">
            <h5>Dents & Scratches</h5>
        </div>
        <div class="nk-wizard-content">
            <div class="row gy-4">
                <div class="col-sm-12" style="padding-bottom: 0 !important;">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="car-diagram-holder"><canvas width="600" height="300" id="car-diagram"></canvas></div>
                        <input type="hidden" name="car_diagram">
                        <div class="signature-tools text-center" id="controls">
                            ...
                            <p class="form-note mb-1 selected-label color-red"><em class="icon ni ni-circle-fill" style="color:#ff0000;"></em> <span class="text-muted">Dents marking selected</span></p>
                            <p class="form-note mb-1 selected-label color-blue" style="display:none;"><em class="icon ni ni-circle-fill" style="color:#1418FF;"></em> <span class="text-muted">Scratch marking selected</span></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea class="form-control defects" name="other_defects" placeholder="Pre Accident / Other Defects" rows="7"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
...
<script type="text/javascript">
    NioApp.asilifywizard("Create Project", "<?=  $user->parent->car_diagram ; ?>");
    NioApp.initPhoneInput();
    $(".select2-dynamic").select2();
    NioApp.initCarDiagram(true);
</script>
<?php return;
