<?php global $s_v_data, $title, $user, $payment, $owner; ?>
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>You are viewing payment #<?=  $payment->id ; ?>.</p>
                                            </div>
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="<?=  url('Supplierpayment@render', array('paymentid' => $payment->id)) ; ?>" download="Payment #<?=  $payment->id ; ?>.pdf"><em class="icon ni ni-download-cloud"></em><span>Download</span></a></li>
                                                                <li><a href="<?=  url('Supplierpayment@render', array('paymentid' => $payment->id)) ; ?>" target="_blank"><em class="icon ni ni-printer"></em><span>Print</span></a></li>
                                                                <li><a class="fetch-display-click" data="paymentid:<?=  $payment->id ; ?>" url="<?=  url('Supplierpayment@updateview') ; ?>" holder=".update-holder-xl" modal="#update-xl" href=""><em class="icon ni ni-pen"></em><span>Edit Payment</span></a></li>
                                                                <li class="divider"></li>
    ...
    <script type="text/javascript">
        ...
        var pdfDocument = "<?=  url('Supplierpayment@render', array('paymentid' => $payment->id)) ; ?>";
