                        ...
                        <div class="item-totals border-top mt-2 pt-2">
                            <div class="row gy-4 d-flex justify-content-end">
                                ...
                                <div class="col-sm-4 text-right">
                                    ...
                                    <div class="fw-normal">Discount: <div class="fw-bold discount"> <input type="number"  class="form-control text-right" name="discount" id="discount" value="<?=  $invoice->discount ; ?>"> </div> </div>
                                    ...
                                    <input type="hidden" name="TaxTotal" id="TaxTotal" value="<?=  $invoice->total ; ?>">
                                    <input type="hidden" name="SubTotal" id="SubTotal" value="<?=  $invoice->subtotal ; ?>">
                                    <input type="hidden" name="GrandTotal" id="GrandTotal" value="<?=  $invoice->tax_amount ; ?>">
                                </div>
                                <div class="col-sm-1">
                                </div>
                            </div>
                            ...
                            <div class="row gy-4 border-top mt-1">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea class="form-control form-control-lg unset-mh" placeholder="Discount Details" rows="2" name="discount_details"><?=  $invoice->discount_details ; ?></textarea>
                                        </div>
