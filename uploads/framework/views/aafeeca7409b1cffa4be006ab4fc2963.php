<?php global $s_v_data, $user, $title, $insurance, $notes, $projects, $staffmembers, $quotes, $invoices, $payments, $jobcards; ?>
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Insurance / <strong class="text-primary small"><?=  $insurance->name ; ?></strong></h3>
                                            <div class="nk-block-des text-soft">
                                                <ul class="list-inline">
                                                    <li>Insurance ID: <span class="text-base">AI<?=  str_pad($insurance->id, 4, '0', STR_PAD_LEFT) ; ?></span></li>
                                                    <li>Created On: <span class="text-base"><?=  date("F j, Y h:ia", strtotime(timezoned($insurance->created_at, $user->parent->timezone))) ; ?></span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>                                                   
                                                 <a href="<?=  url('Insurance@get') ; ?>" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                                    <a href="<?=  url('Insurance@get') ; ?>" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                                                </li>
                                                <li>
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a class="fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Insurance@updateview') ; ?>" holder=".update-holder" modal="#update" href=""><em class="icon ni ni-pen"></em><span>Edit Details</span></a></li>
                                                                <li><a href="" class="fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Jobcards@createform') ; ?>" holder=".update-holder-lg" modal="#update-lg"><em class="icon ni ni-property-add"></em><span>Create Job Card</span></a></li>
                                                                <li><a class="fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Quote@createform') ; ?>" holder=".update-holder-xl" modal="#update-xl" href=""><em class="icon ni ni-cards"></em><span>Create Quote</span></a></li>
                                                                <li><a class="fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Invoice@createform') ; ?>" holder=".update-holder-xl" modal="#update-xl" href=""><em class="icon ni ni-cc"></em><span>Create Invoice</span></a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="" class="send-to-server-click"  data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Insurance@delete') ; ?>" warning-title="Are you sure?" warning-message="This company's profile and data will be deleted permanently." warning-button="Yes, delete!"><em class="icon ni ni-trash"></em><span>Delete Company</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="card-content">
                                                <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                                    <li class="nav-item">
                                                        ...
                                                        <?php if (!isset($_GET['view'])) { ?>
                                                         active
                                                         <?php } ?>
                                                         " href="<?=  url('Insurance@details', array('insuranceid' => $insurance->id)) ; ?>?details"><em class="icon ni ni-file-text"></em><span>Details</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'projects') { ?>
                                                         active
                                                         <?php } ?>
                                                        " href="<?=  url('Insurance@details', array('insuranceid' => $insurance->id)) ; ?>?view=projects"><em class="icon ni ni-todo"></em><span>Projects</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'jobcards') { ?>
                                                         active
                                                         <?php } ?>" href="<?=  url('Insurance@details', array('insuranceid' => $insurance->id)) ; ?>?view=jobcards"><em class="icon ni ni-property-add"></em><span>Job Cards</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'invoices') { ?>
                                                         active
                                                         <?php } ?>
                                                         " href="<?=  url('Insurance@details', array('insuranceid' => $insurance->id)) ; ?>?view=invoices"><em class="icon ni ni-cc"></em><span>Invoices</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'quotes') { ?>
                                                         active
                                                         <?php } ?>
                                                        " href="<?=  url('Insurance@details', array('insuranceid' => $insurance->id)) ; ?>?view=quotes"><em class="icon ni ni-cards"></em><span>Quotes</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link
                                                        <?php if (isset($_GET['view']) && $_GET['view'] == 'payments') { ?>
                                                         active
                                                         <?php } ?>
                                                        " href="<?=  url('Insurance@details', array('insuranceid' => $insurance->id)) ; ?>?view=payments"><em class="icon ni ni-align-left"></em><span>Payments</span></a>
                                                    </li>
                                                </ul><!-- .nav-tabs -->
                                                <?php if (!isset($_GET["view"])) { ?>
                                                <div class="card-inner">
                                                    <div class="nk-block">
                                                        <div class="nk-block-head">
                                                            ...
                                                            <p>Basic  insurance company info, that gives company summary.</p>
                                                        </div><!-- .nk-block-head -->
                                                        <div class="profile-ud-list">
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Company Name</span>
                                                                    <span class="profile-ud-value"><?=  $insurance->name ; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Phone Number</span>
                                                                    <span class="profile-ud-value"><?=  $insurance->phonenumber ; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Email</span>
                                                                    <?php if (!empty($insurance->email)) { ?>
                                                                    <span class="profile-ud-value"><?=  $insurance->email ; ?></span>
                                                                    <?php } else { ?>
                                                            ...
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    ...
                                                                    <span class="profile-ud-value"><?=  $insurance->active_projects ; ?> / <?=  $insurance->total_projects ; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Address</span>
                                                                    <?php if (!empty($insurance->address)) { ?>
                                                                    <span class="profile-ud-value"><?=  $insurance->address ; ?></span>
                                                                    <?php } else { ?>
                                                                    <span class="profile-ud-value">--|--</span>
                                                                    <?php } ?>
                                                                </div>
                                                            ...
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    ...
                                                                    <span class="profile-ud-value"><?=  money($insurance->balance, $user->parent->currency) ; ?></span>
                                                                </div>
                                                            </div>
                                                        </div><!-- .profile-ud-list -->
                                                    </div><!-- .nk-block -->
                                                        ...
                                                        <div class="profile-ud-list">
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    ...
                                                                    <span class="profile-ud-value"><?=  $insurance->total_invoices ; ?> </span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Quotes</span>
                                                                    <span class="profile-ud-value"><?=  $insurance->total_quotes ; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    <span class="profile-ud-label">Payments</span>
                                                                    <span class="profile-ud-value"><?=  money($insurance->total_paid, $user->parent->currency) ; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block mb-2">
                                                        <div class="nk-block-head">
                                                            <h5 class="title">Company Projects</h5>
                                                            <p>A list of <?=  $insurance->name ; ?>'s projects.</p>
                                                        </div><!-- .nk-block-head -->
                                                    </div><!-- .nk-block -->
                                                            ...
                                                            <tr class="nk-tb-item">
                                                                ...
                                                                <td class="nk-tb-col tb-col-md">
                                                                    <div class="user-card">
                                                                        ...
                                                                        <div class="user-info">
                                                                            <span class="tb-lead"><?=  $project->client->fullname ; ?></span>
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block mb-2">
                                                        <div class="nk-block-head">
                                                            <a href="" class="btn btn-primary pull-right fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Jobcards@createform') ; ?>" holder=".update-holder-lg" modal="#update-lg"><em class="icon ni ni-plus"></em><span>Create Job Card</span></a>
                                                            <h5 class="title">Project Job Cards</h5>
                                                            <p>A list of job cards for <?=  $insurance->name ; ?> projects.</p>
                                                        </div><!-- .nk-block-head -->
                                                    </div><!-- .nk-block -->
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block mb-2">
                                                        <div class="nk-block-head">
                                                            <a class="btn btn-primary pull-right fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Invoice@createform') ; ?>" holder=".update-holder-xl" modal="#update-xl" href=""><em class="icon ni ni-plus"></em><span>Create Invoice</span></a>
                                                            <h5 class="title">Company Invoices</h5>
                                                            <p>A list of invoices for <?=  $insurance->name ; ?>.</p>
                                                        </div><!-- .nk-block-head -->
                                                    </div><!-- .nk-block -->
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block mb-2">
                                                        <div class="nk-block-head">
                                                            <a class="btn btn-primary pull-right fetch-display-click" data="insuranceid:<?=  $insurance->id ; ?>" url="<?=  url('Quote@createform') ; ?>" holder=".update-holder-xl" modal="#update-xl" href=""><em class="icon ni ni-plus"></em><span>Create Quote</span></a>
                                                            <h5 class="title">Company Quotes</h5>
                                                            <p>A list of quotes for <?=  $insurance->name ; ?>.</p>
                                                        </div><!-- .nk-block-head -->
                                                    </div><!-- .nk-block -->
                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-block mb-2">
                                                        <div class="nk-block-head">
                                                            ...
                                                            <h5 class="title">Company Payments</h5>
                                                            <p>A list of payments by <?=  $insurance->name ; ?>.</p>
                                                        </div><!-- .nk-block-head -->
                                                    </div><!-- .nk-block -->
            ...
            <div class="modal-content">
                ...
                <form class="simcy-form" action="<?=  url('Notes@create') ; ?>" data-parsley-validate="" method="POST" loader="true">
                    <div class="modal-body">
                        <p>Add a note on this insurance company's account</p>
                        <div class="row gy-4">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="hidden" name="item" value="<?=  $insurance->id ; ?>" required="">
