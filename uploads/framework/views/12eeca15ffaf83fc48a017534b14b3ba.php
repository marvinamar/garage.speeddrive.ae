                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>List of services and parts that are yet to be delivered.</p>
                                            </div>
                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist mt" data-auto-responsive="false">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col tb-col-md"><span class="sub-text">Order / Delivery Date</span></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-md">
                                                                ...
                                                                <?php if ($expense->expected_delivery_date < date("Y-m-d") && $expense->status != "To Order") { ?>
                                                                <span class="text-danger">
                                                                    <?=  date("F j, Y", strtotime($expense->expected_delivery_date)) ; ?> 
                                                                    <?php if (!empty($expense->expected_delivery_time)) { ?>
                                                                    <?=  date("h:ia", strtotime($expense->expected_delivery_time)) ; ?>
                                                                    <?php } ?>
                                                                    <span data-toggle="tooltip" title="Delivery delayed"><em class="icon ni ni-info-fill"></em></span>
                                                                </span>
                                                                <?php } else if ($expense->status != "To Order") { ?>
                                                                <span><?=  date("F j, Y", strtotime($expense->expected_delivery_date)) ; ?>
                                                                    <?php if (!empty($expense->expected_delivery_time)) { ?>
                                                                    <?=  date("h:ia", strtotime($expense->expected_delivery_time)) ; ?>
                                                                    <?php } ?>
                                                                </span>
