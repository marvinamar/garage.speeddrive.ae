<?php global $s_v_data, $title, $user, $project; ?>
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="<?=  url('Vehiclereport@render', array('projectid' => $project->id)) ; ?>" download="<?=  $title ; ?>.pdf"><em class="icon ni ni-download-cloud"></em><span>Download</span></a></li>
                                                                <li><a href="<?=  url('Vehiclereport@render', array('projectid' => $project->id)) ; ?>" target="_blank"><em class="icon ni ni-printer"></em><span>Print</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
    ...
    <script type="text/javascript">
        var pdfDocument = "<?=  url('Vehiclereport@render', array('projectid' => $project->id)) ; ?>";
