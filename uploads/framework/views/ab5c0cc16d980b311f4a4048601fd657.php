<?php global $s_v_data, $project, $user, $staffmembers, $expenses; ?>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" placeholder="Task Name" name="title<?=  $index ; ?>" required="" value="<?=  $work_requested ; ?>">
